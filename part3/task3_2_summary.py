...
def get():
    ...
    p.add_argument("--config", type=str, default="part3/task3_2_elasticity.json")
    p.add_argument("--out", type=str, default="part3/task3_2_summary.json")
    return p.parse_args()
...
def go():
    ...
    tokens_tr = tokens_patch if strat == "grid" else tokens_latent

...
class TransformerConfig:
    ...
    coord_pe: str = "none"
    coord_pe_hidden: int = 64
    relative_bias: str = "none"
    relative_bias_hidden: int = 32
    use_cross_attention: bool = False
    num_seed_tokens: int = 128
...
class GroupQueryFlashAttention(nn.Module):
    ...
    def forward(self,
        ...
        if self.training:
            ...
            dp = 0.0
        x = F.scaled_dot_product_attention(q, k, v, attn_mask=attn_bias, dropout_p=dp)
